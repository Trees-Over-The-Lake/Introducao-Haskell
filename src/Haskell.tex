...
\begin{document} 
    ...
    \begin{figure}[ht]
      \includegraphics[width =\textwidth]{chamarmodulo.png}
    ...
    \begin{figure}[ht]
      \includegraphics[width =\textwidth]{modulos.png}
      \caption{Cabeçalho de um Módulo}
    \end{figure}
    ...
    \begin{figure}[ht]
      \includegraphics[width =\textwidth]{operadores_logicos.png}
    ...
    \begin{figure}[ht]
      \includegraphics[width =\textwidth]{caracteres.png}
    ...
    \begin{apendicesenv}
        ...
        \begin{figure}[ht]
            \includegraphics[scale=0.6]{haskellgoogle.png}
