...
\begin{document} 
    ...
    \begin{figure}[ht]
      \includegraphics[width =300]{chamarmodulo.PNG}
    ...
    \begin{figure}[ht]
      \includegraphics[width =300]{modulos.PNG}
    ...
    \begin{figure}[ht]
      \includegraphics[width =300]{operadores lógicos.PNG}
    ...
    \begin{figure}[ht]
      \includegraphics[width =300]{caracteres.PNG}
    ...
    \begin{figure}[ht]
      \includegraphics[width =300]{classes.PNG}
