...
\begin{document} 
    ...
    \begin{apendicesenv}
        ...
        \emph{cross-platform} torna-se extremamente importante para todas aquelas pessoas que precisem de uma língua que funcione
        em qualquer sistema operacional, seja 
